export const ccaAbi = [
  {
    ...
    inputs: [
      ...
      {name: '_totalSupply', type: 'uint128', internalType: 'uint128'},
      {
        name: '_parameters',
        type: 'tuple',
        ...
        components: [
          ...
          {name: 'tokensRecipient', type: 'address', internalType: 'address'},
          ...
          {name: 'auctionStepsData', type: 'bytes', internalType: 'bytes'},
        ],
      },
    ],
  ...
  },
  {
    type: 'function',
    name: 'claimTokens',
    inputs: [{name: '_bidId', type: 'uint256', internalType: 'uint256'}],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      ...
      {name: '_bidIds', type: 'uint256[]', internalType: 'uint256[]'},
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [],
    outputs: [{name: '', type: 'uint256', internalType: 'ValueX7'}],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: '_outbidBlock', type: 'uint64', internalType: 'uint64'},
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      {name: '_untilTickPrice', type: 'uint256', internalType: 'uint256'},
    ],
    outputs: [{name: '', type: 'uint256', internalType: 'uint256'}],
    stateMutability: 'nonpayable',
  },
    ...
    outputs: [
      {
        ...
        components: [
          {name: 'initialPriceX96', type: 'uint256', internalType: 'uint256'},
    ...
    outputs: [
      {
        ...
        components: [
          {name: 'mps', type: 'uint24', internalType: 'uint24'},
          {name: 'startBlock', type: 'uint64', internalType: 'uint64'},
          {name: 'endBlock', type: 'uint64', internalType: 'uint64'},
        ],
      },
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: '_amount', type: 'uint128', internalType: 'uint128'},
      {name: '_owner', type: 'address', internalType: 'address'},
      {name: '_prevTickPrice', type: 'uint256', internalType: 'uint256'},
      {name: '_hookData', type: 'bytes', internalType: 'bytes'},
    ],
    outputs: [{name: '', type: 'uint256', internalType: 'uint256'}],
    stateMutability: 'payable',
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      {name: '', type: 'address', internalType: 'contract IValidationHook'},
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [
      ...
      {name: 'mps', type: 'uint24', indexed: false, internalType: 'uint24'},
    ],
    anonymous: false,
  },
  {
  ...
  {type: 'error', name: 'AuctionSoldOut', inputs: []},
  {
    ...
    inputs: [
      {name: 'expectedOwner', type: 'address', internalType: 'address'},
      {name: 'receivedOwner', type: 'address', internalType: 'address'},
    ],
  },
  ...
  {type: 'error', name: 'CannotSweepCurrency', inputs: []},
  {type: 'error', name: 'CannotSweepTokens', inputs: []},
  {type: 'error', name: 'CannotUpdateUninitializedTick', inputs: []},
  {type: 'error', name: 'CheckpointBlockNotIncreasing', inputs: []},
  ...
  {type: 'error', name: 'ERC20TransferFailed', inputs: []},
  {
    ...
    inputs: [
      ...
      {name: 'maxBidPrice', type: 'uint256', internalType: 'uint256'},
    ],
  },
  {type: 'error', name: 'FloorPriceAndTickSpacingTooLarge', inputs: []},
  {type: 'error', name: 'FloorPriceIsZero', inputs: []},
  {type: 'error', name: 'FloorPriceTooLow', inputs: []},
  {type: 'error', name: 'FundsRecipientIsZero', inputs: []},
  {type: 'error', name: 'InvalidAmount', inputs: []},
  {type: 'error', name: 'InvalidAuctionDataLength', inputs: []},
  {
    type: 'error',
  ...
  {type: 'error', name: 'InvalidEndBlock', inputs: []},
  {
    type: 'error',
    name: 'InvalidEndBlockGivenStepData',
    inputs: [
      {name: 'actualEndBlock', type: 'uint64', internalType: 'uint64'},
      {name: 'expectedEndBlock', type: 'uint64', internalType: 'uint64'},
    ],
  },
  ...
  {type: 'error', name: 'InvalidOutbidBlockCheckpointHint', inputs: []},
  {
    ...
    inputs: [
      {name: 'actualMps', type: 'uint256', internalType: 'uint256'},
      {name: 'expectedMps', type: 'uint256', internalType: 'uint256'},
    ],
  },
  {type: 'error', name: 'InvalidTickPrice', inputs: []},
  {type: 'error', name: 'InvalidTokenAmountReceived', inputs: []},
  {type: 'error', name: 'MpsRemainingIsZero', inputs: []},
  {type: 'error', name: 'NativeTransferFailed', inputs: []},
  {type: 'error', name: 'NotClaimable', inputs: []},
  {type: 'error', name: 'NotGraduated', inputs: []},
  {type: 'error', name: 'Reentrancy', inputs: []},
  {type: 'error', name: 'StepBlockDeltaCannotBeZero', inputs: []},
  {type: 'error', name: 'StepLib__InvalidOffsetNotAtStepBoundary', inputs: []},
  {type: 'error', name: 'StepLib__InvalidOffsetTooLarge', inputs: []},
  {
    type: 'error',
    name: 'TickHintMustBeGreaterThanNextActiveTickPrice',
    inputs: [
      {name: 'tickPrice', type: 'uint256', internalType: 'uint256'},
      {name: 'nextActiveTickPrice', type: 'uint256', internalType: 'uint256'},
    ],
  },
  ...
  {type: 'error', name: 'TokenAndCurrencyCannotBeTheSame', inputs: []},
  {type: 'error', name: 'TokenIsAddressZero', inputs: []},
  {type: 'error', name: 'TokenTransferFailed', inputs: []},
  {type: 'error', name: 'TokensNotReceived', inputs: []},
  {type: 'error', name: 'TokensRecipientIsZero', inputs: []},
  {type: 'error', name: 'TotalSupplyIsTooLarge', inputs: []},
  {type: 'error', name: 'TotalSupplyIsZero', inputs: []},
  {
    type: 'error',
